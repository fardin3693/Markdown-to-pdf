...
export default function ExcelToPdfPage() {
    ...
    return (
        <>
            <ToolPageHeader title="Excel to PDF" />
            ...
            <div className="container mx-auto px-4 max-w-5xl">
                <div className="text-center mb-10">
                    ...
                    <h1 className="text-4xl font-extrabold text-slate-900 mb-4">Excel to PDF</h1>
                    <p className="text-lg text-slate-600 max-w-2xl mx-auto">
                        Convert Excel spreadsheets to PDF format. Preserve your data and formatting.
                    </p>
                </div>
                    ...
                    <div className="flex flex-col items-center justify-center gap-3">
                        ...
                        <div>
                            <h3 className={`font-bold text-slate-900 ${hasItems ? 'text-lg' : 'text-xl'}`}>
                                {hasItems ? 'Add more files' : 'Drop your Excel files here'}
                            </h3>
                            {!hasItems && (
