...
export default function PdfToPptPage() {
    ...
    const convertItem = async (item: FileQueueItem) => {
        ...
        try {
            const response = await fetch('/api/tools/pdf-to-ppt/convert', {
                method: 'POST',
                body: formData,
            });
            ...
            const filename = `${nameWithoutExt}.pptx`;
    ...
    const handleDownloadAll = async () => {
        ...
        link.href = url;
        link.download = `converted_ppts_${new Date().getTime()}.zip`;
    ...
    return (
        <>
            <ToolPageHeader title="PDF to PPT" />
            ...
            <div className="container mx-auto px-4 max-w-5xl">
                <div className="text-center mb-10">
                    ...
                    <h1 className="text-4xl font-extrabold text-slate-900 mb-4">PDF to PPT</h1>
